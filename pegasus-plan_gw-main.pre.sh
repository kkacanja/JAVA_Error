...
pegasus_lite_log_file="pegasus-plan_gw-main.pre.err"
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///home/kkacanja/pycbc/examples/search/output_shared/gw-main.map", "priority": 0, "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "local", "url": "symlink://$PWD/gw-main.map" }
   ] }
]
eof
...
pegasus-kickstart  -n pegasus-plan_gw-main.pre.sh -N gw-main -R local  -L gw.dax -T 2024-02-19T14:25:21-05:00 /home/kkacanja/pegasus-5.0.6/bin/pegasus-plan $@
job_ec=$?
